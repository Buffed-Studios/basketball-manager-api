...
import com.buffsovernexus.basketball.service.AuthService;
...
public class AuthController {
    ...
    @GetMapping("/me")
    public ResponseEntity<AccountInfoResponse> getMe(@AuthenticationPrincipal UserDetails userDetails) {
